...
public class GenericExerciseTest {
    /**
     * If a GenericExercise is created that stores Strings, then it should be able
     * to set and retrieve String values.
     */
    @Test
    ...
    /**
     * If a GenericExercise is created that stores Objects of type Integer (a
     * wrapper class for ints), then
