...
/**
 * Queues are FIFO - first in, first out, like a checkout line. They are used in
 * algorithms where it is needed to keep
 * track of the order that the elements were inserted in. For instance, tech
 ...
 * ArrayDeque
 * to perform queue operations. You can read about ArrayDeque in the official
 * Javadocs here:
 ...
 *
 * PriorityQueue is another implementation of Queue that has additional
 * functionality
