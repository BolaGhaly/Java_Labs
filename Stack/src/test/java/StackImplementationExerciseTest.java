...
public class StackImplementationExerciseTest {
    ...
    /**
     * A stack with 3 items which then has an item removed should have a size of 2.
     * The removed item
    ...
    /**
     * A stack with 3 items which then has 2 items removed should have a size of 1.
     * The most recently
    ...
    /**
     * Peeking from a stack should return the most recently added item without
