 ...
 * There is no need to change anything in this class. Check out the Model class
 * and Repository class for your tasks.
 */
@SpringBootApplication
public class Application {
    /**
     * You can use the main method to check if the Spring app successfully starts.
     * If you get a set of very
     * long errors rather than this nicely formatted output, that most likely means
     * that the Spring beans failed to
     * load, because the JPARepository could not be initialized, because the Product
     * entity was incorrectly set up.
    ...
    public static void main(String[] args) {
        ...
        // I'm printing the output after the spring app finishes its closing logging
        // messages.
