...
public class App {
        public static void main(String[] args) {
                ...
                System.out.println(
                                "First, let's create a new classroom and student entity and persist them. Then, we'll make "
                                                +
                ...
                Student s1 = studentService.addStudent(new Student("John Doe", 1));
                ...
                System.out.println(
                                "Next, let's try to assign a student to a classroom A202, then retrieve all of the students of"
                                                +
                                                " the classroom.");
                ...
                System.out.println(
                                "Next, let's try to remove the student from classroom A202, then retrieve all of the students of"
                                                +
