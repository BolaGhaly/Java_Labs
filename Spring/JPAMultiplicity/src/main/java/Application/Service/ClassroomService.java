...
/**
 * This service class will demonstrate how to retrieve or manipulate the
 * entities related to the Classroom entity.
 */
@Service
public class ClassroomService {
    ...
    /**
     * Unassign a student from a classroom while retrieving only the clasroom
     * entity.
     * 
     * @param classroomId the Id of an already existing classroom entity.
     * @param studentId   the Id of the student entity to be removed from a
     *                    classroom.
     * @return the persisted student entities
     */
    public void removeStudentFromClassroom(long classroomId, long studentId) {
        ...
        if (classroomOptional.isPresent()) {
            Classroom classroom = classroomOptional.get();
            // lambda expression applied to the collection - this is the same as iterating
