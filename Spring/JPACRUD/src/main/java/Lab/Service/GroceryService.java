...
public class GroceryService {
    ...
    /**
     * Given a brand new transient grocery (meaning, no such grocery exists yet in
     * the database),
     * persist the grocery to the database (create a new database record for the
     * grocery entity.)
     */
    ...
    /**
     * Because fingById() returns a type of Optional<Grocery>, we also need to apply
     * .get() to convert the
     * Optional<Grocery> to Grocery. Optionals help the developer to avoid null
     * pointer exceptions.
     * 
