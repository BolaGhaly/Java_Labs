...
public class Lab {
    /**
     * Notice that the ApplicationContext is itself a bean that can be retrieved
    ...
    /**
     * Retrieves the ElectricPoweredBean from the ApplicationContext by requesting a
     * bean of the class
