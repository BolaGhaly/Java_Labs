...
public class UpdateMessageTextTest {
    ...
    /**
     * Sending an http request to PATCH localhost:8080/messages/1 (message id
     * exists in db) with successfule message text
     *
    ...
    /**
     * Sending an http request to PATCH localhost:8080/messages/1 (message text
     * to update is an empty string)
     *
     * Expected Response: Status Code: 400 Response Body:
     */
    @Test
