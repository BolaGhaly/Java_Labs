...
public class UpdateMessageTextTest {
        ...
        /**
         * Sending an http request to PATCH localhost:8080/messages/1 (message id exists
         * in db) with successfule message text
         * 
         * Expected Response:
         * Status Code: 200
        ...
        /**
         * Sending an http request to PATCH localhost:8080/messages/1 (message id does
         * NOT exist in db)
         * 
         * Expected Response:
         * Status Code: 400
        ...
        /**
         * Sending an http request to PATCH localhost:8080/messages/1 (message text to
         * update is an empty string)
         * 
         * Expected Response:
         * Status Code: 400
         * Response Body:
        ...
        /**
         * Sending an http request to PATCH localhost:8080/messages/1 (message text is
         * too long)
         * 
         * Expected Response:
         * Status Code: 400
