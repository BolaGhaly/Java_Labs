...
public class CreateMessageTest {
    ...
    /**
     * Sending an http request to POST localhost:8080/messages with valid
     * message credentials
     *
    ...
    /**
     * Sending an http request to POST localhost:8080/messages with empty
     * message
     *
     * Expected Response: Status Code: 400 Response Body:
     */
    @Test
    ...
    /**
     * Sending an http request to POST localhost:8080/messages with message
    ...
    /**
     * Sending an http request to POST localhost:8080/messages with a user id
     * that doesnt exist in db
     *
     * Expected Response: Status Code: 400 Response Body:
     */
    @Test
