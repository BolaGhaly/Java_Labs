...
public class BookService {
     ...
     * This is used for when a mock BookDAO that exhibits mock behavior is used in
     * the test cases.
     ...
     * An ISBN will be provided in Book. Method should check if the book ISBN
     * already exists before it attempts to
     * persist it.
     * 
     * @param book a book object.
     * @return book if it was successfully persisted, null if it was not
     *         successfully persisted (eg if the book primary
    ...
    /**
     * TODO: Use the bookDAO to retrieve a list of all books that have a bookCount
     * above 0.
     * 
