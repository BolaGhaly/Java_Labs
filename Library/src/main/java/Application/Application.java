 ...
 * localhost:8080.
 * Take a look at the LibraryController class for API documentation as well as
...
public class Application {
    ...
    /**
     * For the purpose of this short exercise, this method will destroy and set up
     * new book and author tables.
     * This is not a normal way to set up your tables, in real projects you should
     * set up your database
     * schema in a SQL editor such as DBeaver or DataGrip. Do not change anything in
     * this method.
     */
