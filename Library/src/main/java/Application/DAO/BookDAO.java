 ...
 * author_id, which is of type int, and is a foreign key associated with the
 * column 'id' of 'author',
...
public class BookDAO {
     ...
     * You only need to change the sql String and leverage PreparedStatement's
     ...
     * Unlike some of the other insert problems, the primary key here will be
     * provided by the client as part of the
     * Book object. Given the specific nature of an ISBN as both a numerical
     * organization of books outside of this
     * database, and as a primary key, it would make sense for the client to submit
     * an ISBN when submitting a book.
     * You only need to change the sql String and leverage PreparedStatement's
     * setString and setInt methods.
     */
     ...
     * You only need to change the sql String with a query that utilizes a WHERE
     * clause.
     * 
