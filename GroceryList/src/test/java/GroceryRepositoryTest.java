...
public class GroceryRepositoryTest {
    ...
    public void groceryListEmptyOnStartTest(){
        ...
        Assert.assertEquals("getAllGroceries should have a valid SQL statement that gets all groceries.", expectedOutput, allGroceries);
    }
...
//        test that the select all works before trying to insert
        ...
        Assert.assertEquals("addGrocery should have a valid SQL statement that adds a grocery.", expectedOutput, actualOutput);
    }
