...
public class GroceryRepositoryTest {
    ...
    /**
     * Run the same method used in the menu class to drop and recreate the Grocery
     * table.
    ...
    /**
     * When the application starts, the grocery database should not contain any
     * groceries.
     */
    @Test
    ...
    public void groceryListAddTest1() {
        ...
        Assert.assertEquals("addGrocery should have a valid SQL statement that adds a grocery.", expectedOutput,
                actualOutput);
    }
