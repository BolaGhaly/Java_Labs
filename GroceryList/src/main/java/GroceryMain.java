 ...
 * You can, however, run this class to play with a CLI menu that interacts with
...
public class GroceryMain {
     ...
     * new grocery table.
     * This is not a normal way to set up your tables, in real-world projects you
     * would likely set up your database
